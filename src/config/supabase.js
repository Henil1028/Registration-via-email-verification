...
console.log("[Supabase Config Client Init] URL:", supabaseUrl);
console.log("[Supabase Config Client Init] Key Length:", supabaseAnonKey ? supabaseAnonKey.length : 0);
console.log("[Supabase Config Client Init] Key (first 10/last 10):", supabaseAnonKey ? `${supabaseAnonKey.slice(0, 10)}...${supabaseAnonKey.slice(-10)}` : "undefined");
